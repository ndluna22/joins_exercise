...
SELECT first_name, last_name, COUNT (*) AS count FROM vehicles JOIN owners ON owner_id = owners.id 
...
FROM vehicles 
JOIN owners ON owner_id = owners.id GROUP BY (first_name, last_name) 
